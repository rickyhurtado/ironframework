...
define([
  ...
  var DataView = Backbone.View.extend(
  {
    ...
    template :
    {
      dataPage : new EJS( {url: I.JsPath + '/module/data/template/' + I.JsVersion + '/data-page.' + I.JsVersion + '.html'} ),
      category : new EJS( {url: I.JsPath + '/module/data/template/' + I.JsVersion + '/category.' + I.JsVersion + '.html'} ),
      contacts : new EJS( {url: I.JsPath + '/module/data/template/' + I.JsVersion + '/contacts.' + I.JsVersion + '.html'} )
    },
